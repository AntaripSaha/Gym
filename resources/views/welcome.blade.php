...
@section('content')
    <div id="wrapper">
                            ...
                            <ul class="menuzord-menu" style="text-align: start;">
                                ...
                                <li><a href="#">Pages</a>
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="page-course-gird.html">Courses</a>
                                        </li>
        ...
        <div class="main-content">
                ...
                <div class="container-fluid p-0">
                    ...
                    <div id="rev_slider_home_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="news-gallery34" style="margin:0px auto;background-color:#ffffff;padding:0px;margin-top:0px;margin-bottom:0px;">
                        ...
                        <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
                            <ul>
                                <!-- SLIDE 1 -->
                                <li data-index="rs-1" data-transition="slingoverlayhorizontal" data-slotamount="default" data-easein="deult" data-easeout="default" data-masterspeed="default" data-umb="{{asset('frontend/images/gym/bg/bg1.jpg')}}" data-rotate="0"  data-fstransiti="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
                                    <!-- MAIN IMAGE -->
                                ...
                                <!-- SLIDE 3 -->
                                <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="{{asset('frontend/images/gym/bg/bg1.jpg')}}" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
                                    <!-- MAIN IMAGE -->
                                    <img src="{{asset('frontend/images/gym/bg/bg1.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                                    <!-- LAYERS -->
                                    <!-- LAYER NR. 1 -->
                                    <!--                <div class="tp-caption tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0"-->
                                    <!--                  id="slide-3-layer-1"-->
                    ...
                    <div class="section-title text-center">
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <h2 class=" line-bottom-double-line-centered mt-0">Welcome to <span class="text-theme-colored2">Fitness</span> Zone</h2>
                    ...
                    <div class="section-content text-center">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-3 mb-sm-40 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                                <img class="img-circle img-thumbnail mb-15" src="{{asset('frontend/images/gym/about/sq1.jpg')}}" alt="">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 mb-sm-40 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.4s">
                                <img class="img-circle img-thumbnail mb-15" src="{{asset('frontend/images/gym/about/sq2.jpg')}}" alt="">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 mb-sm-40 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                                <img class="img-circle img-thumbnail mb-15" src="{{asset('frontend/images/gym/about/sq3.jpg')}}" alt="">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 mb-sm-0 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.6s">
                                <img class="img-circle img-thumbnail mb-15" src="{{asset('frontend/images/gym/about/sq4.jpg')}}" alt="">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-6">
                                <div class="upcoming-event p-30 mb-30 bg-theme-colored2-transparent-9">
                                    <div class="event-thumb pull-right flip sm-pull-none"><img class="" alt="" src="{{asset('frontend/images/gym/event/sq1.jpg')}}"></div>
                                    <div class="event-content text-white">
                                        <h3 class="mt-0"><a href="page-event-single.html" class="text-white">Strong Body Strong Mind</a></h3>
                                        ...
                                        <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas eveniet, nemo dicta. Ullam nam.</p>
                                ...
                                <div class="upcoming-event p-30 mb-30 bg-theme-colored-transparent-9">
                                    <div class="event-thumb pull-right flip sm-pull-none"><img class="" alt="" src="{{asset('frontend/images/gym/event/sq2.jpg')}}"></div>
                                    <div class="event-content text-white">
                                        <h3 class="mt-0 text-white"><a href="page-event-single.html" class="text-white">Group Classes For Everyone</a></h3>
                                        <ul class="mb-5 text-white">
                                            <li><i class="fa fa-calendar-plus-o mr-10"></i>June 26, 2019</li>
                                            <li><i class="fa fa-clock-o mr-10"></i>9:00 AM - 5:00 PM</li>
                                            <li><i class="fa fa-globe mr-10"></i>New York</li>
            ...
            <section data-bg-color="#E3DAD3">
                <div class="container">
                    <div class="section-title text-center">
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <h2 class="text-uppercase line-bottom-double-line-centered mt-0"> Why <span class="text-black">Choose Us </span></h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem autem<br> voluptatem obcaecati!</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="icon-box icon-theme-colored benefit-icon tmedia text-right p-0 mb-sm-10 mt-30">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>Ecoforestry is a creative skill and a joy beyond anything found within conventional forestry</p>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                                <div class="box-hover-effect thumb-cross-effect">
                                    <div class="effect-wrapper">
                                        <div class="thumb">
                                            <img class="img-fullwidth" src="{{asset('frontend/images/gym/services/1.jpg')}}" alt="project">
                                        </div>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                                <div class="box-hover-effect thumb-cross-effect">
                                    <div class="effect-wrapper">
                                        <div class="thumb">
                                            <img class="img-fullwidth" src="{{asset('frontend/images/gym/services/2.jpg')}}" alt="project">
                                        </div>
                                        <!--                  <div class="text-holder text-holder-top-left">-->
                                        <!--                    <div class="title text-theme-colored2 font-22">-->
                                        <!--                      $70-->
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                                <div class="box-hover-effect thumb-cross-effect">
                                    <div class="effect-wrapper">
                                        <div class="thumb">
                                            <img class="img-fullwidth" src="{{asset('frontend/images/gym/services/3.jpg')}}" alt="project">
                                        </div>
                                        <!--                  <div class="text-holder text-holder-top-left">-->
                                        <!--                    <div class="title text-theme-colored2 font-22">-->
                                        <!--                      $70-->
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                                <div class="box-hover-effect thumb-cross-effect">
                                    <div class="effect-wrapper">
                                        <div class="thumb">
                                            <img class="img-fullwidth" src="{{asset('frontend/images/gym/services/4.jpg')}}" alt="project">
                                        </div>
                                        <!--                  <div class="text-holder text-holder-top-left">-->
                                        <!--                    <div class="title text-theme-colored2 font-22">-->
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                                <div class="box-hover-effect thumb-cross-effect">
                                    <div class="effect-wrapper">
                                        <div class="thumb">
                                            <img class="img-fullwidth" src="{{asset('frontend/images/gym/services/5.jpg')}}" alt="project">
                                        </div>
                                        <!--                    <div class="text-holder text-holder-top-left">-->
                                        <!--                      <div class="title text-theme-colored2 font-22">-->
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                                <div class="box-hover-effect thumb-cross-effect">
                                    <div class="effect-wrapper">
                                        <div class="thumb">
                                            <img class="img-fullwidth" src="{{asset('frontend/images/gym/services/6.jpg')}}" alt="project">
                                        </div>
                                        <!--                  <div class="text-holder text-holder-top-left">-->
                                        <!--                    <div class="title text-theme-colored2 font-22">-->
                                        <!--                      <i class="fa fa-dolar-o mr-10">$85</i>-->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered bg-white text-center class-time mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td><img class="img-circle pb-5" src="{{asset('frontend/images/time-table/1.jpg')}}" alt=""><br>
                                                <a href="#"><strong>Yoga training</strong> <br>
                                                    7 am-6 am</a></td>
                                            <td><i class="pe-7s-close font-30 mt-40"></i></td>
                                            <td><img class="img-circle pb-5" src="{{asset('frontend/images/time-table/2.jpg')}}" alt=""><br>
                                                <a href="#"><strong>Yoga training</strong> <br>
                                                    7 am-6 am</a></td>
                                            <td><i class="pe-7s-close font-30 mt-40"></i></td>
                                            <td><img class="img-circle pb-5" src="{{asset('frontend/images/time-table/3.jpg')}}" alt=""><br>
                                                <a href="#"><strong>Yoga training</strong> <br>
                                                    7 am-6 am</a></td>
                                            <td><i class="pe-7s-close font-30 mt-40"></i></td>
                                        </tr>
                                        <tr>
                                            <td><img class="img-circle pb-5" src="{{asset('frontend/images/time-table/4.jpg')}}" alt=""><br>
                                                <a href="#"><strong>Yoga training</strong> <br>
                                                    7 am-6 am</a></td>
                                            <td><i class="pe-7s-close font-30 mt-40"></i></td>
                                            <td><img class="img-circle pb-5" src="{{asset('frontend/images/time-table/5.jpg')}}" alt=""><br>
                                                <a href="#"><strong>Yoga training</strong> <br>
                                                    7 am-6 am</a></td>
                                            <td><i class="pe-7s-close font-30 mt-40"></i></td>
                                            <td><img class="img-circle pb-5" src="{{asset('frontend/images/time-table/6.jpg')}}" alt=""><br>
                                                <a href="#"><strong>Yoga training</strong> <br>
                                                    7 am-6 am</a></td>
                                            <td><i class="pe-7s-close font-30 mt-40"></i></td>
                                            <td><img class="img-circle pb-5" src="{{asset('frontend/images/time-table/1.jpg')}}" alt=""><br>
                        ...
                        <div class="col-md-12">
                            <div class="owl-carousel-4col" data-nav="true" data-dots="true">
                                <div class="item">
                                    <div class="team-members text-center maxwidth400">
                                        <div class="team-thumb">
                                            <img class="img-fullwidth" alt="" src="{{asset('frontend/images/gym/team/1.jpg')}}">
                                        </div>
                                        <div class="team-details">
                                            <div class="p-10 bg-theme-colored">
                                                <h4 class="team-title text-uppercase mt-0 mb-0"><a href="#">Gordon James</a></h4>
                                ...
                                <div class="item">
                                    <div class="team-members text-center maxwidth400">
                                        <div class="team-thumb">
                                            <img class="img-fullwidth" alt="" src="{{asset('frontend/images/gym/team/2.jpg')}}">
                                        </div>
                                        <div class="team-details">
                                            <div class="p-10 bg-theme-colored">
                                                <h4 class="team-title text-uppercase mt-0 mb-0"><a href="#">James Steward</a></h4>
                                ...
                                <div class="item">
                                    <div class="team-members text-center maxwidth400">
                                        <div class="team-thumb">
                                            <img class="img-fullwidth" alt="" src="{{asset('frontend/images/gym/team/3.jpg')}}">
                                        </div>
                                        <div class="team-details">
                                            <div class="p-10 bg-theme-colored">
                                ...
                                <div class="item">
                                    <div class="team-members text-center maxwidth400">
                                        <div class="team-thumb">
                                            <img class="img-fullwidth" alt="" src="{{asset('frontend/images/gym/team/4.jpg')}}">
                                        </div>
                                        <div class="team-details">
                                            <div class="p-10 bg-theme-colored">
                                                <h4 class="team-title text-uppercase mt-0 mb-0"><a href="#">Jason Doenly</a></h4>
                                ...
                                <div class="item">
                                    <div class="team-members text-center maxwidth400">
                                        <div class="team-thumb">
                                            <img class="img-fullwidth" alt="" src="{{asset('frontend/images/gym/team/5.jpg')}}">
                                        </div>
                                        <div class="team-details">
                                            <div class="p-10 bg-theme-colored">
                                                <h4 class="team-title text-uppercase mt-0 mb-0"><a href="#">Mike Wilson</a></h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
                                <div class="funfact text-center">
                                    ...
                                    <h2 data-animation-duration="2000" data-value="1283" class="animate-number text-white font-38">0</h2>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="gallery-isotope default-animation-effect grid-3 gutter-small clearfix" data-lightbox="gallery">
                                    ...
                                    <div class="gallery-item design">
                                        <div class="thumb">
                                            <img class="img-fullwidth" src="{{asset('frontend/images/gym/gallery/1.jpg')}}" alt="project">
                                            ...
                                            <div class="icons-holder">
                                                <div class="icons-holder-inner">
                                                    <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                        <a href="{{asset('frontend/images/gym/gallery/full/1.jpg')}}" data-lightbox-gallery="gallery" title="Your Title Here"><i class="fa fa-picture-o"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="gallery-item branding photography">
                                        <div class="thumb">
                                            <img class="img-fullwidth" src="{{asset('frontend/images/gym/gallery/2.jpg')}}" alt="project">
                                            <div class="overlay-shade"></div>
                                            <div class="text-holder">
                                                <div class="title text-center">Sample Title</div>
                                            </div>
                                            <div class="icons-holder">
                                                <div class="icons-holder-inner">
                                                    <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                        <a href="{{asset('frontend/images/gym/gallery/full/2.jpg')}}" data-lightbox-gallery="gallery" title="Your Title Here"><i class="fa fa-picture-o"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="gallery-item design">
                                        <div class="thumb">
                                            <img class="img-fullwidth" src="{{asset('frontend/images/gym/gallery/3.jpg')}}" alt="project">
                                            <div class="overlay-shade"></div>
                                            <div class="text-holder">
                                                <div class="title text-center">Sample Title</div>
                                            </div>
                                            <div class="icons-holder">
                                                <div class="icons-holder-inner">
                                                    <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                        <a href="{{asset('frontend/images/gym/gallery/full/3.jpg')}}" data-lightbox-gallery="gallery" title="Your Title Here"><i class="fa fa-picture-o"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="gallery-item branding">
                                        <div class="thumb">
                                            <img class="img-fullwidth" src="{{asset('frontend/images/gym/gallery/4.jpg')}}" alt="project">
                                            <div class="overlay-shade"></div>
                                            <div class="text-holder">
                                                <div class="title text-center">Sample Title</div>
                                            </div>
                                            <div class="icons-holder">
                                                <div class="icons-holder-inner">
                                                    <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                        <a href="{{asset('frontend/images/gym/gallery/full/4.jpg')}}" data-lightbox-gallery="gallery" title="Your Title Here"><i class="fa fa-picture-o"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="gallery-item design photography">
                                        <div class="thumb">
                                            <img class="img-fullwidth" src="{{asset('frontend/images/gym/gallery/5.jpg')}}" alt="project">
                                            <div class="overlay-shade"></div>
                                            <div class="text-holder">
                                                <div class="title text-center">Sample Title</div>
                                            </div>
                                            <div class="icons-holder">
                                                <div class="icons-holder-inner">
                                                    <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                        <a href="{{asset('frontend/images/gym/gallery/full/5.jpg')}}" data-lightbox-gallery="gallery" title="Your Title Here"><i class="fa fa-picture-o"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="gallery-item photography">
                                        <div class="thumb">
                                            <img class="img-fullwidth" src="{{asset('frontend/images/gym/gallery/6.jpg')}}" alt="project">
                                            <div class="overlay-shade"></div>
                                            <div class="text-holder">
                                                <div class="title text-center">Sample Title</div>
                                            </div>
                                            <div class="icons-holder">
                                                <div class="icons-holder-inner">
                                                    <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                        <a href="{{asset('frontend/images/gym/gallery/full/6.jpg')}}" data-lightbox-gallery="gallery" title="Your Title Here"><i class="fa fa-picture-o"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <section  class="divider parallax layer-overlay overlay-theme-colored2-8" data-bg-img="{{asset('frontend/images/gym/bg/bg10.jpg')}}">
                <div class="container">
                    <div class="call-to-action">
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1 text-center">
                                <h2 class="text-white text-uppercase font-36">fitness is not a destination its a way of life</h2>
                                <p class="text-white lead">Start War on Fat - Have Energy. Strong Body Strong Mind flexibility, and mind-body awareness.Balance - Fitness For Life</p>
                                ...
                                <div class="owl-carousel-4col" data-nav="true" data-dots="true">
                                    <div class="item">
                                        <div class="product">
                                            ...
                                            <div class="product-thumb"> <img alt="" src="{{asset('frontend/images/gym/shopping/1.jpg')}}" class="img-responsive img-fullwidth">
                                            ...
                                            <div class="product-details text-center bg-light p-20">
                                                ...
                                                <a class="btn btn-dark btn-theme-colored btn-add-to-cart" href="#">Add To Cart</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="product">
                                            <span class="tag-sale">Sale!</span>
                                            <div class="product-thumb"> <img alt="" src="{{asset('frontend/images/gym/shopping/2.jpg')}}" class="img-responsive img-fullwidth">
                                                <div class="overlay"></div>
                                            </div>
                                            <div class="product-details text-center bg-light p-20">
                                    ...
                                    <div class="item">
                                        <div class="product">
                                            <span class="tag-sale">Sale!</span>
                                            <div class="product-thumb"> <img alt="" src="{{asset('frontend/images/gym/shopping/3.jpg')}}" class="img-responsive img-fullwidth">
                                                <div class="overlay"></div>
                                            </div>
                                            <div class="product-details text-center bg-light p-20">
                                    ...
                                    <div class="item">
                                        <div class="product">
                                            <span class="tag-sale">Sale!</span>
                                            <div class="product-thumb"> <img alt="" src="{{asset('frontend/images/gym/shopping/4.jpg')}}" class="img-responsive img-fullwidth">
                                                <div class="overlay"></div>
                                            </div>
                                            <div class="product-details text-center bg-light p-20">
                                    ...
                                    <div class="item">
                                        <div class="product">
                                            <span class="tag-sale">Sale!</span>
                                            <div class="product-thumb"> <img alt="" src="{{asset('frontend/images/gym/shopping/5.jpg')}}" class="img-responsive img-fullwidth">
                                                <div class="overlay"></div>
                                            </div>
                                            <div class="product-details text-center bg-light p-20">
            ...
            <section class="divider parallax layer-overlay overlay-theme-colored-8" data-bg-img="{{asset('frontend/images/gym/bg/bg10.jpg')}}">
                <div class="container">
                    <div class="section-title text-center">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="owl-carousel-3col" data-dots="true">
                                        ...
                                        <div class="testimonial testimonial-yoga">
                                            ...
                                            <div class="content mt-20">
                                                <div class="thumb pull-left flip mr-20">
                                                    <img class="img-circle img-thumbnail" alt="" src="{{asset('frontend/images/testimonials/1.jpg')}}">
                                                </div>
                                    ...
                                    <div class="item">
                                        <div class="testimonial testimonial-yoga">
                                            ...
                                            <div class="content mt-20">
                                                <div class="thumb pull-left flip mr-20">
                                                    <img class="img-circle img-thumbnail" alt="" src="{{asset('frontend/images/testimonials/2.jpg')}}">
                                                </div>
                                                <div class="pull-left flip mt-10">
                                                    <h5 class="author text-white">Tegan Bolton</h5>
                                                    <h6 class="author-title text-white">Happy Client</h6>
                                    ...
                                    <div class="item">
                                        <div class="testimonial testimonial-yoga">
                                            ...
                                            <div class="content mt-20">
                                                <div class="thumb pull-left flip mr-20">
                                                    <img class="img-circle img-thumbnail" alt="" src="{{asset('frontend/images/testimonials/3.jpg')}}">
                                                </div>
                                                <div class="pull-left flip mt-10">
                                                    <h5 class="author text-white">Tegan Bolton</h5>
                                                    <h6 class="author-title text-white">Happy Client</h6>
                                    ...
                                    <div class="item">
                                        <div class="testimonial testimonial-yoga">
                                            ...
                                            <div class="content mt-20">
                                                <div class="thumb pull-left flip mr-20">
                                                    <img class="img-circle img-thumbnail" alt="" src="{{asset('frontend/images/testimonials/4.jpg')}}">
                                                </div>
                                                <div class="pull-left flip mt-10">
                                                    <h5 class="author text-white">Tegan Bolton</h5>
                                                    <h6 class="author-title text-white">Happy Client</h6>
                        ...
                        <div class="row">
                                ...
                                <article class="post clearfix maxwidth500 mb-sm-30">
                                    <div class="entry-header">
                                        <div class="post-thumb">
                                            <img src="{{asset('frontend/images/gym/blog/1.jpg')}}" alt="" class="img-responsive img-fullwidth">
                                        </div>
                                    </div>
                                    <div class="entry-content border-bottom-theme-color-2-1px bg-lighter p-30">
                                        <h3 class="entry-title text-uppercase mt-0"><a href="#">10 healthiest tips for both men and women  </a></h3>
                                        <div class="entry-meta mb-20">
                                            <ul class="list-inline font-12">
                                                <li><i class="fa fa-calendar-plus-o text-theme-color-2 mr-5"></i> 25 March, 2018</li>
                                            </ul>
                                        </div>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <article class="post clearfix maxwidth500  mb-sm-30">
                                    <div class="entry-header">
                                        <div class="post-thumb">
                                            <img src="{{asset('frontend/images/gym/blog/3.jpg')}}" alt="" class="img-responsive img-fullwidth">
                                        </div>
                                    </div>
                                    <div class="entry-content border-bottom-theme-color-2-1px bg-lighter p-30">
                                        <h3 class="entry-title text-uppercase mt-0"><a href="#">Maintaining Your Body Is No Small Matter </a></h3>
                                        <div class="entry-meta mb-20">
                                            <ul class="list-inline font-12">
                                                <li><i class="fa fa-calendar-plus-o text-theme-color-2 mr-5"></i> 25 March, 2018</li>
                                            </ul>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <article class="post clearfix maxwidth500">
                                    <div class="entry-header">
                                        <div class="post-thumb">
                                            <img src="{{asset('frontend/images/gym/blog/2.jpg')}}" alt="" class="img-responsive img-fullwidth">
                                        </div>
                                    </div>
                                    <div class="entry-content border-bottom-theme-color-2-1px bg-lighter p-30">
                                        <h3 class="entry-title text-uppercase mt-0"><a href="#">Get off your butt and exercise orders</a></h3>
                                        <div class="entry-meta mb-20">
                                            <ul class="list-inline font-12">
                                                <li><i class="fa fa-calendar-plus-o text-theme-color-2 mr-5"></i> 25 March, 2018</li>
                                            </ul>
                ...
                <div class="container pt-10 pb-0">
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- Section: Clients -->
                                <div class="owl-carousel-6col transparent text-center owl-nav-top p-5" style="margin-bottom: 20px !important;margin-top: 15px;">
                                    <div class="item"> <a href="#"><img src="{{asset('frontend/images/clients/w1.png')}}" height="80px" alt=""></a></div>
                                    <div class="item"> <a href="#"><img src="{{asset('frontend/images/clients/w2.png')}}" height="80px" alt=""></a></div>
                                    <div class="item"> <a href="#"><img src="{{asset('frontend/images/clients/w3.png')}}" height="80px" alt=""></a></div>
                                    <div class="item"> <a href="#"><img src="{{asset('frontend/images/clients/w4.png')}}" height="80px" alt=""></a></div>
                                    <div class="item"> <a href="#"><img src="{{asset('frontend/images/clients/w5.png')}}" height="80px" alt=""></a></div>
                                    <div class="item"> <a href="#"><img src="{{asset('frontend/images/clients/w6.png')}}" height="80px" alt=""></a></div>
                                    <div class="item"> <a href="#"><img src="{{asset('frontend/images/clients/w3.png')}}" height="80px" alt=""></a></div>
                                    <div class="item"> <a href="#"><img src="{{asset('frontend/images/clients/w4.png')}}" height="80px" alt=""></a></div>
                                    <div class="item"> <a href="#"><img src="{{asset('frontend/images/clients/w5.png')}}" height="80px" alt=""></a></div>
                                    <div class="item"> <a href="#"><img src="{{asset('frontend/images/clients/w6.png')}}" height="80px" alt=""></a></div>
                ...
                <div class="row border-bottom-black">
                    <div class="col-sm-6 col-md-3">
                        <div class="widget dark">
                            <img class="mt-10 mb-20" alt="" src="{{asset('frontend/images/logo-wide-white-footer.png')}}" style="height: 145px !important;">
                            <!-- <p>Lorem ipsum dolor adipisicing amet, consectetur sit elit. Aspernatur incidihil quo officia.</p> -->
                            <ul class="list-inline mt-5">
                                <li class="m-0 pl-10 pr-10"> <i class="fa fa-map-marker text-theme-colored mr-5"></i>
                                    <a class="text-gray" href="#">Shatha Tower 9th Floor Media City
                                        Dubai, United Arab Emirates,
                                    </a>
                                </li>
                                <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-theme-colored mr-5"></i> <a class="text-gray" href="#">123-456-789</a> </li>
                                <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-theme-colored mr-5"></i> <a class="text-gray" href="#">info@tkmmafit.com</a> </li>
                                <li class="m-0 pl-10 pr-10"> <i class="fa fa-globe text-theme-colored mr-5"></i> <a class="text-gray" href="#">https://tkmmafit.com/</a> </li>
                            </ul>
                        </div>
                        <div class="widget dark">
                        ...
                        <div class="widget dark">
                            ...
                            <div class="latest-posts">
                                <article class="post media-post clearfix pb-0 mb-10">
                                    <a href="#" class="post-thumb"><img alt="" src="#"></a>
                                    <div class="post-right">
                                        <h5 class="post-title mt-0 mb-5"><a href="#">Yoga lessons now offered</a></h5>
                                        <p class="post-date mb-0 font-12">Jan 08, 2023</p>
                                    </div>
                                </article>
                                <article class="post media-post clearfix pb-0 mb-10">
                                    <a href="#" class="post-thumb"><img alt="" src="#"></a>
                                    <div class="post-right">
                                        <h5 class="post-title mt-0 mb-5"><a href="#">Swimming classes now open</a></h5>
                                        <p class="post-date mb-0 font-12">Feb 08, 2023</p>
                                    </div>
                                </article>
                                <article class="post media-post clearfix pb-0 mb-10">
                                    <a href="#" class="post-thumb"><img alt="" src="#"></a>
                                    <div class="post-right">
                                        <h5 class="post-title mt-0 mb-5"><a href="#">Kick boxing competition</a></h5>
                                        <p class="post-date mb-0 font-12">Mar 08, 2023</p>
                                    </div>
                                </article>
                            </div>
                        </div>
                ...
                <div class="container pt-10 pb-0">
                    <div class="row">
                        <div class="col-md-6 sm-text-center">
                            <p class="font-13 text-black-777 m-0">Copyright &copy;2022 Easital. All Rights Reserved</p>
                        </div>
                        <div class="col-md-6 text-right flip sm-text-center">
                            <div class="widget no-border m-0">
                                <ul class="styled-icons icon-dark icon-circled icon-sm mb-5">
                                    <img src="{{asset('frontend/images/payment-card-logo-sm.png')}}" alt="" srcset="" width="280px" height="auto">
                                </ul>
                            </div>
                        </div>
                    </div>
