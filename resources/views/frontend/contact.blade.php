                    ...
                    <div class="col-md-6">
                        ...
                        <div class="icon-box media mb-15"> <a class="media-left pull-left flip mr-20" href="#"> <i class="pe-7s-map-2 text-theme-colored"></i></a>
                            <div class="media-body">
                                ...
                                <p>Shatha Tower 9th Floor Media City Dubai, United Arab Emirates,</p>
                            </div>
                        </div>
                        ...
                        <div class="icon-box media mb-15"> <a class="media-left pull-left flip mr-15" href="#"> <i class="pe-7s-mail text-theme-colored"></i></a>
                            <div class="media-body">
                                ...
                                <p><a href="mailto:supporte@yourdomin.com">supporte@tkmmafit.com</a></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section>
            <div class="container-fluid pt-0 pb-0">
                <div class="row">
                    ...
                    <script src="{{asset('frontend/js/google-map-init-multilocation.js')}}"></script>
